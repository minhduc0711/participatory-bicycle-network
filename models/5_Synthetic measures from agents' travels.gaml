...
global {
    ...
    int number_of_sensors <- 1000; //represente le nombre de cyclistes équipés de capteurs dans la ville
    ...
    init{ 
		...
		int number_of_leisures_with_sensor <- 1; // int(number_of_leisures / number_of_agents * number_of_sensors);
