...
global {
    ...
    int number_of_sensors <- 1000; // nombre de capteurs distribués à la population dans le modèle 5
    ...
    init{ 
		...
		int number_of_leisures_test <- 1; //int(number_of_leisures / number_of_agents * number_of_test_travels);
